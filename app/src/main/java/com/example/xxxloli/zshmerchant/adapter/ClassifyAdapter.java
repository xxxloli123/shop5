...
//    private int  selectItem=-1;
    ...
    public ClassifyAdapter(Context mContext, ArrayList<Classify> classifies) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (mSelect == i) {
            holder.classifyText.setBackgroundColor(Color.parseColor("#FFFFFF"));
            holder.hint.setVisibility(View.VISIBLE);
        }else {
            holder.classifyText.setBackgroundColor(Color.parseColor("#F6F6F6"));
